@foreach($items as $faq)
    ...
    >
        ...
        <div itemprop="name" class="collapse-title after:text-3xl border-gray-500 font-bold border-b-2">{{$faq->_faq_question}}</div>
        <div itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer" class="collapse-content bg-primary font-bold text-primary-content">
