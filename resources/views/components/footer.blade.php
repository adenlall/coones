                ...
                <div itemscope itemtype="https://schema.org/WebSite" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 text-sm">
                  <nav aria-label="Breadcrumb">
                    ...
                    <div>
                        ...
                        <h3 class="font-semibold mb-2">
                          <a itemprop="url" href="#">
                            كود خصم ريفي للمفاصل
                          </a>
                        </h3>
                        <h3 class="font-semibold mb-2">
                          <a itemprop="url" href="#">
                            كود خصم فورايفر كولسيت
                          </a>
                        </h3>
                    </div>
                    <div>
