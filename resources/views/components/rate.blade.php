<div class="flex-center-row gap-2 {{app('request')->input('review')&& (string) app('request')->input('modal') === (string) $id?'pb-6':''}}">
    ...
    <div class="flex-center-row gap-2">
        <div class="h-fit m-0">
            <button title="Submit form" onclick="postReview({couponId:'{{$id}}', storeName:'{{$store}}', review:'1', fingerprint:'{{\Illuminate\Support\Str::random(25)}}' })" type="submit" class="flex-center-row gap-1 border-gray-400 border-[1px] text-base-content/80 py-1 px-3 rounded">
        ...
        <div class="h-fit m-0">
            <button title="Submit form" onclick="postReview({couponId:'{{$id}}', storeName:'{{$store}}', review:'0', fingerprint:'{{\Illuminate\Support\Str::random(25)}}' })" type="submit" class="flex-center-row gap-1 border-gray-400 border-[1px] text-base-content/80 py-1 px-3 rounded">
